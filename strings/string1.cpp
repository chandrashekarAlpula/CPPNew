...
//String compare using compare function
void f10(){
	string s1 = "This";
	string s2 = "That";

	switch(s1.compare(s2)){
	//switch(s1.compare(0,2, s2, 0 , 2)){
		case 0 :
			cout <<"Equale \n";
			break;
		case -1 :
...
void f11(){
	...
	string s1 = "BSC_10-01";
        if(int x = s1.find_first_not_of("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_") != std::string::npos){

		cout << "Found string " << x << endl ;
        }else{
		cout << "Not Found string " << endl ;
